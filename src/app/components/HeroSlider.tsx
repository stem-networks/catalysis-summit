...
const HeroSlider: React.FC<BannerSectionProps> = ({
    generalbannerInfo,
    onelinerBannerInfo,
}) => {
    ...
    return (
        <div>
            ...
            <section className="hero-conference-section">
                <div className="hero-conference-image">
                    <Image
                    ...
                    />
                    {/* Polygon Shape */}
                    <div className="hero-triangle-shape"></div>
                </div>
                <div className="hero-conference-content">
                    <div className="auto-container">
                        <div className="hero-flex-content">
                            ...
                            <div className="hero-date-card wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                                <h4 className="hero-shortname">{general?.csname}</h4>
                                <div className="hero-date"><span>{general?.full_length_dates}</span></div>
                                <div className="hero-venue">{general?.venue_p1}</div>
                            </div>
