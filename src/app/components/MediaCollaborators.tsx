                    ...
                    <ul className="slider" ref={sliderRef}>
                        ...
                        <li className="slideimg">
                            <Link href="https://allconferencealert.net/" title="All Conference Alert" target="_blank">
                                <Image
                                    src="/images/media-collaborators/all_conf_alert.webp"
                        ...
                        <li className="slideimg">
                            <Link href="https://internationalconferencealerts.com/" title="International Conference Alerts" target="_blank">
                                <Image
                                    src="/images/media-collaborators/intern_conf_alerts.webp"
                        ...
                        <li className="slideimg">
                            <Link href="https://conferencenext.com/" title="Conference Next" target="_blank">
                                <Image
                                    src="/images/media-collaborators/conference_next.webp"
                                    alt="Conference Next"
                                    title="Conference Next"
                                    width={180}
                                    height={100}
                                />
                            </Link>
                        ...
                        <li className="slideimg">
                            <Link href="https://www.clocate.com/catalysis-and-chemical-engineering-global-conference-ccgc/105043/" title="Conference Locate" target="_blank">
                                <Image
                                    src="/images/media-collaborators/conference_locate.webp"
                                    alt="Conference Locate"
                                    title="Conference Locate"
                                    width={180}
                                    height={100}
                                />
                            </Link>
                        ...
                        <li className="slideimg">
                            <Link href="https://www.conferencelists.org/event/catalysis-and-chemical-engineering-global-conference/" title="Conference List" target="_blank">
                                <Image
                                    src="/images/media-collaborators/conference_list.webp"
                                    alt="Conference List"
                        ...
                        <li className="slideimg">
                            <Link href="https://kindcongress.com/event/ccgc-2025/" title="Kind Congress" target="_blank">
                                <Image
                                    src="/images/media-collaborators/kind_cong.webp"
                                    alt="Kind Congress"
                                    title="Kind Congress"
                                    width={180}
                                    height={100}
                        ...
                        <li className="slideimg">
                            <Link href="https://www.conference2go.com/event/catalysis-and-chemical-engineering-global-conference/" title="Conference2go" target="_blank">
                                <Image
                                    src="/images/media-collaborators/conference2go.webp"
                                    alt="Conference2go"
                                    title="Conference2go"
                                    width={180}
                                    height={100}
